...
var storage = multer.diskStorage({
  ...
  destination: function (req, file, cb) {
    cb(null, PATH.resolve(__dirname, '../public/uploads/usersPics'))
  },
  // 文件名字
  filename: function (req, file, cb) {
    ...
    req.body.usersLogo = '/uploads/usersPics/' + _filename
    cb(null, _filename)
  }
})
...
// 已经是一个中间件了
var upload = multer({ storage, fileFilter }).single('usersLogo') // multer.single处理单文件上层,还有一个处理多文件的
